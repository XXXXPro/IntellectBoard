...
{% elseif post.rating_value=="1" %}<a href="unrate.htm?p={{ post.id }}"><i class="fas fa-thumbs-up"></i></a>
...
{% elseif post.rating_value=="-1" %}<a href="unrate.htm?p={{ post.id }}"><i class="fas fa-thumbs-down"></i></a>
